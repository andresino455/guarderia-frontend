...
import {
  ...
  eliminarUsuario, activarUsuario,
  cambiarPassword, getRoles,crearRol,editarRol,eliminarRol,
...
export default function UsuariosList() {
  ...
  const abrirEditar = (u) => {
    ...
    setForm({
      ...
      password: '', id_rol: u.id_rol, activo: u.activo,
    })
    setModalMsg(null)
    setModal(true)
  }
  ...
  const handleGuardar = async () => {
    ...
    setModalMsg(null)
    try {
      const payload = { nombre: form.nombre, email: form.email, id_rol: form.id_rol, activo: form.activo }
            ...
            <div className={styles.modalBody}>
              ...
              <div className={styles.formGrid}>
                ...
                <div className={`${styles.formField} ${styles.full}`}>
                  ...
                  <select
                    name="id_rol" value={form.id_rol}
                    onChange={handleChange} className={styles.select2}
                  >
            ...
            <div className={styles.modalBody}>
              ...
              <div className={styles.pwdSection}>
                <div className={styles.formField}>
                  ...
                  <input
                    type="password" value={pwd.password_actual}
                    onChange={e => setPwd(p => ({ ...p, password_actual: e.target.value }))}
                    className={styles.input} placeholder="Contraseña actual"
                  />
                </div>
                <div className={styles.formField}>
                  <label className={styles.label}>Nueva contraseña *</label>
                  <input
                    type="password" value={pwd.password_nueva}
                    onChange={e => setPwd(p => ({ ...p, password_nueva: e.target.value }))}
                    className={styles.input} placeholder="Mínimo 8 caracteres"
                  />
                </div>
                <div className={styles.formField}>
                  <label className={styles.label}>Confirmar nueva contraseña *</label>
                  <input
                    type="password" value={pwd.password_confirmacion}
                    onChange={e => setPwd(p => ({ ...p, password_confirmacion: e.target.value }))}
                    className={styles.input} placeholder="Repetí la nueva contraseña"
                  />
                </div>
              </div>
            </div>
